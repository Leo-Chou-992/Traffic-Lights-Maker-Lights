...
-- Date        : Thu Jul 30 11:08:51 2020
-- Host        : LAPTOP-6HR1D0VC running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim {c:/Vivado
--               documents/SEA_exp/lights/lights.srcs/sources_1/ip/Driver_SK6805_0/Driver_SK6805_0_sim_netlist.vhdl}
...
architecture STRUCTURE of Driver_SK6805_0_Driver_SK6805 is
  ...
  signal \Send_Cnt[7]_i_3_n_0\ : STD_LOGIC;
  signal \Send_Cnt[7]_i_4_n_0\ : STD_LOGIC;
  ...
  signal \Send_State_reg[0]_i_13_n_0\ : STD_LOGIC;
  signal \Send_State_reg[0]_i_5_n_0\ : STD_LOGIC;
  signal \Send_State_reg[0]_i_8_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \Data_Cnt[6]_i_2\ : label is "soft_lutpair6";
  ...
  attribute SOFT_HLUTNM of \Data_Cnt[8]_i_3\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of LED_IO_i_4 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \Send_Cnt[1]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \Send_Cnt[2]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \Send_Cnt[2]_i_3\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \Send_Cnt[4]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \Send_Cnt[5]_i_2\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \Send_Cnt[7]_i_3\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \Send_Cnt[7]_i_4\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \Send_Cnt[8]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \Send_Cnt[9]_i_3\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \Send_Cnt[9]_i_4\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \Send_State[0]_i_7\ : label is "soft_lutpair7";
...
\Send_Cnt[0]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\Send_Cnt[2]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\Send_Cnt[7]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
...
\Send_Cnt[7]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\Send_Cnt[9]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0080"
    )
        port map (
...
\Send_State[0]_i_23\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AFA0CFCFAFA0C0C0"
    )
        port map (
...
\Send_State[0]_i_7\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\Send_State_reg[0]_i_13\: unisim.vcomponents.MUXF7
     port map (
...
\Send_State_reg[0]_i_5\: unisim.vcomponents.MUXF7
     port map (
...
\Send_State_reg[0]_i_8\: unisim.vcomponents.MUXF7
     port map (
...
entity Driver_SK6805_0 is
  ...
  attribute X_CORE_INFO of Driver_SK6805_0 : entity is "Driver_SK6805,Vivado 2019.1";
end Driver_SK6805_0;
