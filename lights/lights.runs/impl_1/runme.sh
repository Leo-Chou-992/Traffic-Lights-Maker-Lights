...
HD_PWD='C:/Vivado documents/SEA_exp/lights/lights.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lights.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lights.tcl -notrace
