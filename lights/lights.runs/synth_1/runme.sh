...
HD_PWD='C:/Vivado documents/SEA_exp/lights/lights.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lights.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lights.tcl
