...
HD_PWD='D:/gf/Study Resource/XILINX/summer_class/sea_traffic/sea_traffic/sea_traffic.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sea_traffic.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sea_traffic.tcl -notrace
