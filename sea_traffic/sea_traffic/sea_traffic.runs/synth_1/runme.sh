...
HD_PWD='D:/gf/Study Resource/XILINX/summer_class/sea_traffic/sea_traffic/sea_traffic.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sea_traffic.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sea_traffic.tcl
